  ...
  register({
    ...
    exec: function(uri, content) {
      var code = [
        ...
        '  var BbaseHandlebars = require("handlebars")["default"]',
        '  module.exports = function(data, options) {',
        '    options || (options = {})',
        '    options.helpers || (options.helpers = {})',
        '    for (var key in BbaseHandlebars.helpers) {',
        '      options.helpers[key] = options.helpers[key] || BbaseHandlebars.helpers[key]',
        '    }',
        '    return BbaseHandlebars.compile(source)(data, options)',
        '  }',
        '})'
      ].join('\n')
