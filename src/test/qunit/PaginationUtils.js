...
QUnit.test("getMaxPage -> 1ms*1", function(assert){
    ...
    var page = 2;
    var pageSize = 5;
    var num = BbaseEst.getMaxPage(parseInt(48), parseInt(7));
...
QUnit.test("getListByPage -> 1ms*1", function(assert){
    ...
    var page = 2;
    var pageSize = 5;
    var list = BbaseEst.getListByPage(pageList, page, pageSize);
...
QUnit.test("getPaginationNumber -> 1ms*3", function(assert){
    var list = BbaseEst.getPaginationNumber(parseInt(1), parseInt(50), 9);
    var list2 = BbaseEst.getPaginationNumber(parseInt(44), parseInt(50), 9);
    var result = [ 1, 2, 3, 4, 5, 6, 7 ];
    var result2 = [ 41, 42, 43, 44, 45, 46, 47];
    assert.deepEqual(list, result, 'passed!');
    assert.deepEqual(list2, result2, 'passed!');
    var list3 = BbaseEst.getPaginationNumber(1, 1, 9);
