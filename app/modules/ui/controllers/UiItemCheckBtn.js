...
/**
 * @description 模块功能说明
 * @class UiItemCheckBtn
 * @author yongjin<zjut_wyj@163.com> 2016/2/6
 */
define('UiItemCheckBtn', [], function (require, exports, module) {
  ...
  template = `
    <div class="UiItemCheckBtn-wrap module-wrap">
        ...
        <div class="anything">
          ...
          <div class="main">
            <div class="demo-item clearfix" bb-bbaseuiitembtn="{viewId:'itemchecknormal',cur:cur,items:items}"></div>
          </div>
          <div class="footer">
  ...
  UiItemCheckBtn = BbaseView.extend({
    initialize: function () {
      this._super({
        template: template
      });
