 ...
 */
define('UiFormSelect', [], function(require, exports, module){
  var UiFormSelect, template;

  template = `
    <div class="UiFormSelect-wrap"  style="padding:10px;">
    <div class="formPanel form-demo">
        <div class="anything" style="display: block;">
          ...
          <div class="main">
            <div class="demo-item clearfix" bb-bbaseuiselect="{viewId:'bbaseuiselect',cur:cur,items:items}"></div>
          </div>
          <div class="footer">
