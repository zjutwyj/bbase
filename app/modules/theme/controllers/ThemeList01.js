 ...
 */
define('ThemeList01', [], function (require, exports, module) {
  var ThemeList01;
  ...
  ThemeList01 = BbaseList.extend({
    initialize: function () {
      var theme = BbaseEst.nextUid('ThemeList01');
      this._super({
        template: `
          <div class="ThemeList01-wrap ${theme}-wrap" style="padding: 20px; background-color: ${CONST.LIGHTEN_COLOR};">
            <style>
