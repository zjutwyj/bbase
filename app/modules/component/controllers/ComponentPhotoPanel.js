...
/**
 * @description 模块功能说明
 * @class ComponentPhotoPanel
 * @author yongjin<zjut_wyj@163.com> 2016/2/6
 */
define('ComponentPhotoPanel', [], function(require, exports, module){
  var ComponentPhotoPanel, template;

  template = `
    <div class="ComponentPhotoPanel-wrap" style="padding:20px;">
...
<div class="formPanel form-demo">
          ...
          <div class="main">
            ...
            <table class="content">
              <tbody class="uilist01-tbody">
                ...
                <tr>
                  <td class="argName"><span>showCropBtn</span></td>
                  <td class="argDesc"><span>显示裁切按钮</span></td>
  ...
  ComponentPhotoPanel = BbaseView.extend({
    initialize: function(){
      this._super({
        template: template
      });
  ...
  module.exports = ComponentPhotoPanel;
});