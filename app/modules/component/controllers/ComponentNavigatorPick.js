...
/**
 * @description 模块功能说明
 * @class ComponentNavigatorPick
 * @author yongjin<zjut_wyj@163.com> 2016/2/6
 */
define('ComponentNavigatorPick', [], function(require, exports, module){
  var ComponentNavigatorPick, template;

  template = `
    <div class="ComponentNavigatorPick-wrap" style="padding:20px;">
...
<div class="formPanel form-demo">
        <div class="anything" style="display: block;">
          ...
          <div class="main">
          <div  class="demo-item clearfix"><a href="javascript:;" bb-bbasecomponentnavigatorpick="{viewId: 'componentNavigator1', items: items, cur: cur, onChange: handleChnage}">选择导航</a></div>
          </div>
          <div class="footer">
          ...
          <div class="main">
            ...
            <table class="content">
              <tbody class="uilist01-tbody">
                ...
                <tr>
                  <td class="argName"><span>navigarorIdPath</span></td>
                  <td class="argDesc"><span>分类ID</span></td>
                  <td class="argType"><span>string</span></td>
                  <td class="argDefault"><span>id</span></td>
                </tr>
                <tr>
                  <td class="argName"><span>parentIdPath</span></td>
                  <td class="argDesc"><span>上级分类ID字段</span></td>
                  <td class="argType"><span>string</span></td>
                  <td class="argDefault"><span>id</span></td>
                </tr>
                <tr>
                  <td class="argName"><span>namePath</span></td>
                  <td class="argDesc"><span>分类名称</span></td>
                  <td class="argType"><span>string</span></td>
                  <td class="argDefault"><span>name</span></td>
                </tr>
                <tr>
                  <td class="argName"><span>imagePath</span></td>
                  <td class="argDesc"><span>分类图片</span></td>
                  <td class="argType"><span>string</span></td>
                  <td class="argDefault"><span>imagePath</span></td>
                </tr>
  ...
  ComponentNavigatorPick = BbaseView.extend({
    initialize: function(){
      this._super({
        template: template
      });
  ...
  module.exports = ComponentNavigatorPick;
});