 ...
 */
define('BbaseScrollbar', [], function(require, exports, module){

  if (!window.addEventListener) { module.exports = null;
    return; }
  /*iscroll*/
  (function(g, n, f) {
    ...
    function s(a, b, c,d) {
      ...
      !0 === c && (e.style.cssText =
        "position:absolute;z-index:" + (d || '1999'), d.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;background:rgba(0,0,0,0.15);border:1px solid rgba(255,255,255,0.9);border-radius:3px");
    ...
    p.prototype = {
      ...
      _initIndicators: function() {
        ...
        var b = this.options.interactiveScrollbars,
          ...
          d, f = this;
        this.indicators = [];
        this.options.scrollbars && (this.options.scrollY && (d = { el: s("v", b, this.options.scrollbars, this.options.zIndex), interactive: b, defaultScrollbars: !0, customStyle: c, resize: this.options.resizeScrollbars, shrink: this.options.shrinkScrollbars, fade: this.options.fadeScrollbars, listenX: !1 }, this.wrapper.appendChild(d.el),
          e.push(d)), this.options.scrollX && (d = { el: s("h", b, this.options.scrollbars, this.options.zIndex), interactive: b, defaultScrollbars: !0, customStyle: c, resize: this.options.resizeScrollbars, shrink: this.options.shrinkScrollbars, fade: this.options.fadeScrollbars, listenY: !1 }, this.wrapper.appendChild(d.el), e.push(d)));
