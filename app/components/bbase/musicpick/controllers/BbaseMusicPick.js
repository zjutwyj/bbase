 ...
 */
define('BbaseMusicPick', ['BbaseItemCheck'], function (require, exports, module) {
  var BbaseMusicPick, template, BbaseItemCheck;
  ...
  BbaseMusicPick = BbaseList.extend({
    ...
    initFileUpload: function (options) {
      ...
      $('#' + viewId, options.target).fileupload({
        ...
        start: function (e) {
          if (!window.$uploading) {
            window.$uploading = $('<div class="bbase-component-musicpick-ploading"></div>');
